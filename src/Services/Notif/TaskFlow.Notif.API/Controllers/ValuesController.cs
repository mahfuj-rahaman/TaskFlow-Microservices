...
namespace TaskFlow.Notif.API.Controllers;

/// <summary>
/// Sample Values controller for testing Notif service
/// </summary>
[ApiController]
...
public class ValuesController : ControllerBase
{
    ...
    {
        return Ok(new[] { "notif-value1", "notif-value2", "notif-value3" });
    }
